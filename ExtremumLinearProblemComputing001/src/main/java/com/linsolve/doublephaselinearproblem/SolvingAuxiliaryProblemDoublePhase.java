...
public class SolvingAuxiliaryProblemDoublePhase
{
	private BuildingAugmentedMatrixDoublePhase bam;
	...
	public SolvingAuxiliaryProblemDoublePhase(BuildingAugmentedMatrixDoublePhase bam) 
	{
		this.bam = bam;
	...
	{	
		...
		{					
			for( int j=0; j<augmented_matrix[0].length-1;j++)
			{
				...
				else if(i<this.augmented_matrix_phase_II.length && j<this.augmented_matrix_phase_II[0].length && j+this.bam.getNegative_mult()<this.augmented_matrix[0].length)
	    		{
	    			this.augmented_matrix_phase_II[i][j]=this.augmented_matrix[i][j+this.bam.getNegative_mult()];
	    		}
			}
	...
	{
		for(int j=0;j<this.bam.getAugmented_matrix_phase_II()[0].length-1;j++)
		 {
	...
	public BuildingAugmentedMatrixDoublePhase getBam() {
		return bam;
	}

	public void setBam(BuildingAugmentedMatrixDoublePhase bam) {
		this.bam = bam;
	}

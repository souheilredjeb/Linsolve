...
public class SolvingDoublePhaseMinimize 
{
	...
	public SolvingDoublePhaseMinimize()
	{

	}
	
	public SolvingDoublePhaseMinimize(SolvingAuxiliaryProblemDoublePhase solver_phase_I) {
		super();

...
public class BuildingAugmentedMatrixSinglePhase {
	...
	public BuildingAugmentedMatrixSinglePhase() 
	{
	...
	public BuildingAugmentedMatrixSinglePhase(Double[][] initial_matrix, Double[] b_vector, Double[] c_vector) {
		super();
